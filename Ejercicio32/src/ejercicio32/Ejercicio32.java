...
public class Ejercicio32 {
    ...
    public static void main(String[] args) {
      ...
      cantiad50 = numero / CINCUENTA ;
      
      cantiad20 = (numero % CINCUENTA)/VEINTE ;
      
      cantiad10 = ((numero % CINCUENTA)%VEINTE)/ DIEZ ;

      cantiad2 = (((numero % CINCUENTA)%VEINTE)% DIEZ)/DOS ;

      cantiad1 = ((((numero % CINCUENTA)%VEINTE)% DIEZ)%DOS) /UNO ;
